var $User = (function () {
  ...
  ShadowPNG =
    "images/interface/plantshadow" +
    ($User.Browser.IE6
      ? (document.execCommand("BackgroundImageCache", false, true), "8.gif")
      : "32.png"),
  innerText = (function () {
    return $User.Browser.IE
      ? (($Random = "?"),
        function (b, a) {
          b.innerText = a;
        })
  ...
  oS = {
      ...
      switch (p.Coord) {
        case 2:
          NewImg(
            ...
            "",
            ($Pn.oPoolCleaner = NewEle(0, "div", "position:absolute"))
          );
        case 1:
          NewImg(
            0,
            ...
            "",
            ($Pn.oLawnCleaner = NewEle(0, "div", "position:absolute"))
          );
          break;
      }
      while (r--) {
    ...
    CheckImg: function (d, c) {
      ...
      if (g.AccessNum == g.PicNum) {
        ...
        innerText(
          $("sFlagMeterTitleF"),
          ($("dFlagMeterTitleB").firstChild.data = g.LevelName)
        );
                  ...
                  j < 500
                    ...
                    : (DisplayZombie(),
                      ...
                      oS.CanSelectCard
                        ...
                        : (AutoSelectCard(), oSym.addTask(200, LetsGO, [])));
                },
                []
              )
...
(oP = {
    ...
    a && a.FlagNum
      ? ((r.FlagHeadStep = Math.floor(140 / (a.FlagNum - 1))),
        (r.MonPrgs = function () {
          ...
          !--j.NumZombies &&
            (f < j.FlagNum
              ? ((j.ReadyFlag = ++f), oSym.addTask(500, j.FlagPrgs, []))
              : j.FlagToEnd());
        }))
      : (r.MonPrgs = function () {});
    (!a || !a.FlagToEnd) &&
  ...
  SetTimeoutTomZombie: function (c) {
    ...
    for (b in oGd.$Tombstones) {
      g = b.split("_");
      d[e] = (f[e] = new c[Math.floor(Math.random() * a)]()).CustomBirth(
        g[0],
        g[1],
        100
      );
  ...
  SetTimeoutWaterZombie: function (j, b, e, h) {
    ...
    c = e;
    while (c--) {
      k[c] = (m[c] = new h[Math.floor(Math.random() * g)]()).CustomBirth(
  ...
  (oGd = {
    ...
    MB1: function (e, j, m, f) {
      ...
      n < 1 &&
        f[g + "_" + c] &&
        l != c &&
        ((e.Kind = ++n) && (h = e.Attack = 40),
        (e.ChangeC = c),
        (k.src = "images/Plants/PB" + n + a + ".gif"));
      b && b.Altitude == 1
        ? (b.getHurt(-1, a, h, n, 0, 0, 0),
          m.splice(j, 1),
          (SetStyle(k, { left: e.pixelLeft + 28 + "px" }).src =
            "images/Plants/PeaBulletHit.gif"),
          oSym.addTask(10, ClearChild, [k]))
        : (e.X += p = !a ? 5 : -5) < oS.W && e.X > 100
        ? (k.style.left = (e.pixelLeft += p) + "px")
        : (m.splice(j, 1), ClearChild(k));
    },
    MB2: function (d, g, h) {
      var c = d.id,
        j = d.X,
        ...
        e = $(c);
      b && b.Altitude == 1
        ? (b.getHurt(-1, 0, 20, 0, 0, 0, 0),
          h.splice(g, 1),
          (SetStyle(e, { left: d.pixelLeft + 38 + "px" }).src =
            "images/Plants/ShroomBulletHit.gif"),
          oSym.addTask(10, ClearChild, [e]))
        : (d.X += 5) < oS.W
        ? (e.style.left = (d.pixelLeft += 5) + "px")
        : (h.splice(g, 1), ClearChild(e));
    },
    MB3: function (g, d, a) {
      var h = g.id,
        b = $(h),
      ...
      if (f && f.Altitude == 1) {
        ...
        switch (g.D) {
          case 4:
            (g.X -= 5) < 100
              ? (a.splice(d, 1), ClearChild(b))
              : (b.style.left = (g.pixelLeft -= 5) + "px");
            break;
          case 6:
            (c = g.pixelTop -= 5) < -15
              ? (a.splice(d, 1), ClearChild(b))
              : ((b.style.top = c + "px"), (g.R = GetR(c + 15)));
            break;
          case 2:
            (c = g.pixelTop += 5) > 600
              ? (a.splice(d, 1), ClearChild(b))
            ...
            break;
          case 7:
            (g.X += 4.3) > 900 || (c = g.pixelTop -= 5) < -15
              ? (a.splice(d, 1), ClearChild(b))
              : ((g.R = GetR(c + 15)),
                (b.style.left = (g.pixelLeft += 9.6) + "px"),
                (b.style.top = c + "px"));
            break;
          case 1:
            (g.X += 4.3) > 900 || (c = g.pixelTop += 5) > 600
              ? (a.splice(d, 1), ClearChild(b))
              : ((g.R = GetR(c + 15)),
                (b.style.left = (g.pixelLeft += 9.6) + "px"),
                (b.style.top = c + "px"));
  ...
  (DisplayZombie = function () {
    ...
    while (l2) {
      ...
      d[l2--] = f.getHTML(
        "",
        Math.floor(50 + Math.random() * 201) - f.width * 0.5,
        e[l2] - f.height,
        1,
        "block",
        "auto",
  ...
  (InitPCard = function () {
    ...
    while (b < a) {
      ...
      d +=
        ...
        EName +
        '" onmouseout="SetVisible($(\'dTitle\'))" onmousemove="ViewCardTitle(' +
        EName +
  ...
  (InitHandBookPCard = function () {
    ...
    $("dHandBookPZ").style.backgroundImage =
      "url(images/interface/Almanac_PlantBack.jpg)";
  ...
  (InitHandBookZCard = function () {
    ...
    $("dHandBookPZ").style.backgroundImage =
      "url(images/interface/Almanac_ZombieBack.jpg)";
    SetVisible($("dHandBookPZ"));
    SetNone($("dHandBookP"));
    SetBlock($("dHandBookZ"));
  }),
  ...
  (ViewProduceZombie = function (b) {
    var a = b.prototype;
    $("pHandBookZombie").style.backgroundImage =
      "url(" + a.PicArr[a.StandGif] + ")";
  ...
  (ViewCardTitle = function (b, c) {
    ...
    f.innerHTML =
      ...
      "秒<br>" +
      (oS.DKind && a.night
        ? '<span style="color:#F00">夜行性的--在白天会睡觉</span><br>' +
          a.Tooltip
        : a.Tooltip);
    SetStyle(f, {
  ...
  (SelectCard = function (e) {
    ...
    if (!b.Select) {
      ...
      oS.StaticCard &&
        ...
        NewImg(0, c.src, 0, h),
        NewImg(0, g.src, 0, h),
        innerText(NewEle("sSunNum" + e, "span", 0, 0, h), j.SunNum),
        SetNone(g));
    } else {
      b.Select = 0;
      !--ArPCard.SelNum &&
        ((f.disabled = "disabled"), (f.style.color = "#888"));
  ...
  (ViewPlantTitle = function (b) {
    var f = $("dTitle"),
      ...
      a = c.CName;
    !oS.CardKind &&
      ((a += "<br>冷却时间:" + c.coolTime + "秒<br>" + c.Tooltip),
      !e.CDReady &&
        (a += '<br><span style="color:#F00">正在重新装填中...</span>'));
    ...
    while (b--) {
      ...
      switch (a) {
        ...
        case 7.5:
          d.CDReady = 1;
          e <= oS.SunNum &&
            ((d.SunReady = 1), SetVisible($(d.DID).childNodes[1]));
          break;
        case 30:
          DoCoolTimer(b, 20);
          break;
  ...
  (MonitorCard = function (c) {
    ...
    if (oS.Chose < 1) {
      while (a--) {
        (b = (c = ArCard[a]).PName.prototype).SunNum > oS.SunNum
          ? (c.SunReady && (c.SunReady = 0), SetHidden($(c.DID).childNodes[1]))
          : (!c.SunReady && (c.SunReady = 1),
            c.CDReady && SetVisible($(c.DID).childNodes[1]));
      }
    } else {
      while (a--) {
        (b = (c = ArCard[a]).PName.prototype).SunNum > oS.SunNum
          ? c.SunReady && (c.SunReady = 0)
          : !c.SunReady && (c.SunReady = 1);
      }
    }
  ...
  (DoCoolTimer = function (c, b) {
    ...
    (function (d, g, f, e) {
      d > 0
        ? (innerText(f, d),
          innerText(e, d),
          oSym.addTask(50, arguments.callee, [(d - 0.5).toFixed(1), g, f, e]))
  ...
  (ChosePlant = function (a, f) {
    ...
    !oS.CardKind
      ? EditImg(
          EditImg(
            $Pn[d.EName].childNodes[1].cloneNode(false),
            "MovePlant",
            "",
            {
      ...
      : (NewImg(
          ...
          d.PicArr[d.StandGif],
          "left:" +
            (g - 0.5 * (d.beAttackedPointL + d.beAttackedPointR)) +
            "px;top:" +
            (e + 20 - d.height) +
            "px;z-index:254",
          EDAll
  ...
  (GrowPlant = function (k, d, c, e, b) {
    ...
    j.CanGrow(k, e, b) &&
      (!oS.CardKind
        ? new g().Birth(d, c, e, b, k)
        : asyncInnerHTML(
            (a = new g()).CustomBirth(e, b, 0, "auto"),
            function (m, l) {
      ...
      innerText(ESSunNum, (oS.SunNum -= j.SunNum)),
      SetHidden($(f.DID).childNodes[1]),
      h && ((f.CDReady = 0), DoCoolTimer(i, j.coolTime)),
  ...
  (AppearSun = function (h, f, e, a) {
    ...
    a
      ...
      : ((d = f - b - 20),
        (c += ";top:" + d + "px"),
        oSym.addTask(800, DisappearSun, [g]));
  ...
  (ClickSun = function (c) {
    ...
    a &&
      a.C &&
      ((a.C = 0),
      innerText(ESSunNum, (oS.SunNum = Math.min(b + a.N, 9990))),
      oSym.addTask(0, MoveClickSun, [c]).addTask(0, MonitorCard, []));
  }),
  ...
  (PrepareGrowPlants = function (a) {
    NewImg(
      "PrepareGrow",
      "images/interface/PrepareGrowPlants.gif" + $Random + Math.random(),
      "z-index:50;left:" +
        (oS.W * 0.5 - 77) +
        "px;top:" +
        (oS.H * 0.5 - 54) +
  ...
  (CheckSilence = function (a) {
    ...
    b != oS.Silence &&
      ...
      b ? ClearMusic() : NewMusic(oS.StartGameMusic));
  }),
  (GetNewCard = function (a, b, c) {
    ...
    NewEle(
      "DivA",
      "div",
      "width:900px;height:600px;background:#FFF;z-index:255",
      0,
      EDAll
    );
    oSym.Init(
      function (d, e) {
        ++d < 100
          ? (SetAlpha(e, d, d * 0.01),
            oSym.addTask(1, arguments.callee, [d, e]))
          : (function () {
  ...
  (WordUTF8 =
    '<div id="dLogo" style="position:absolute;width:900px;height:600px;z-index:1"><image src="images/interface/LogoWord.jpg" style="position:absolute;left:320px;top:15px"><div id="LogoWord" style="position:absolute;color:#FF0;top:480px;width:100%;height:100px"><span style="position:absolute;width:332px;height:94px;left:90px;top:5;cursor:pointer;background:url(images/interface/LoadBar.png)" onclick="SetBlock($(\'dSurface\'),$(\'iSurfaceBackground\'))"></span><span style="position:absolute;font-size:14px;left:450px;top:50px;line-height:1.5;font-weight:bold"><span style="cursor:pointer" onclick="SetVisible($(\'dProcess\'))">关于本程序</span>&nbsp;<span id="sTime"></span><br> <a href="../../index.html" style="font-size:20px;color:#FF0;font-family:verdana">返回</a></div></div>'),
  ...
  (LoadLvl = function (d, c) {
    ...
    var b = oS.CenterContent,
      a = $("dAD");
    (d = d || 0) && oSym.Now == c
      ? ((d = 0), b && ((a.innerHTML = b), SetBlock(a)))
      : b && SetBlock(a);
    oSym.Init(
      function (f) {
        var e = $("JSPVZ");
        ...
        NewEle(
          ...
          "script",
          "",
          { src: "level/" + (oS.Lvl = f) + ".js", type: "text/javascript" },
  ...
  (AppearTombstones = function (m, d, l) {
    ...
    while (l--) {
      ...
      NewEle(
        "",
        "div",
        "background-position:-" + 86 * b + "px -" + 91 * g + "px",
        { className: "Tom1" },
        a
      );
      NewEle(
  ...
  (PauseGame = function (b) {
    ...
    a.Timer
      ? (a.Stop(),
        ...
        ($("dPauseAD").innerHTML = oS.CenterContent
  ...
  (LoadProProcess = function () {
    ...
    a
      ? ($User.Browser.IE
        ...
        (a.src =
          "http://" + $User.AuthorWebsite + "/js/Process.js?" + Math.random()))
...
($SSml = function (d, c, a) {
  ...
  (ShowAD = function (h, g) {
    ...
    NewEle(
      "dAD",
      "div",
      "position:absolute;left:285px;top:125px;z-index:200",
      0,
      $("dAll")
    ).innerHTML = d;
    NewEle(
      "dAD2",
      "div",
      "position:absolute;left:903px;top:0;z-index:200",
      0,
      document.body
    ).innerHTML = c;
    oS.CenterContent = d;
    document.write(
      '<div id="dLink"><div><a href="http://www.xiazai.com/" target="_blank" style="color:#FF0;font-weight:bold"><img src="images/link/a5logo.png" border="0" title="非常感谢a5下载网站友情赞助的空间" height="59"></a></div><div><a href="http://www.xiaody.com" target="_blank"><img height="59" src="http://www.xiaody.com/logo.gif" alt="小电影" border="0"></a></div>'
    );
    ...
    google_ad_height = 60;
    document.write(
      '<div><script src="http://pagead2.googlesyndication.com/pagead/show_ads.js"></script></div><div><script src="http://s9.cnzz.com/stat.php?id=2462431&web_id=2462431&show=pic"></script></div>'
    );
    $User.TopisAuthorWebsite &&
      (function () {
        _gaq = [];
  ...
  (NewMusic = function (a) {
    $("oEmbed").innerHTML =
      '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="0" height="0" align="middle"><param name="allowScriptAccess" value="always"/><param name="allowFullScreen" value="false" /><param name="movie" value="music/' +
      a +
      '" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" /><embed width="0" height="0" src="music/' +
      a +
      '" quality="high" pluginspage="http://www.adobe.com/go/getflashplayer_cn" align="middle" play="true" loop="true" scale="showall" wmode="window" devicefont="false" bgcolor="#ffffff" name="ad" menu="true" allowfullscreen="false" allowscriptaccess="always" salign="" type="application/x-shockwave-flash"></object>';
  }),
  (ClearMusic = function () {
    $("oEmbed").innerHTML = "";
  });
